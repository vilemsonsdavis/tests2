...
public class Desas {
    ...
    public void DesasGo() {
        ...
        while (turpinatVaiNe) {
            ...
            System.out.println("Speele DESAS ir saakusies!");

            DesasSpele game = new DesasSpele();
            ...
            System.out.println("Ja gribi spelet velreiz desas ievadi true, ja negribi ievadi false! ");
